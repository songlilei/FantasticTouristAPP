    ...
    fetchDestinations() {
        return function (dispatch, getState) {
            ...
            if (hasMore && !loading) {
                ...
                dispatch({type: types.FETCH_DESTINATIONS_SUCCESS, payload: getDestinations(offset,limit,txt)});
            }
        }
    },
    refreshDestinations() {//下拉刷新
        return function (dispatch, getState) {
            ...
            if (!loading) {
                ...
                dispatch({type: types.REFRESH_DESTINATIONS_SUCCESS, payload: getDestinations(0, limit,txt)});
            }
        }
    },
    searchTxt(txt) {
        return function (dispatch, getState) {
            ...
            actions.refreshDestinations()(dispatch, getState);
        }
    }
}
